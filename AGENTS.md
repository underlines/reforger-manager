...
## Answer style (ISO house style, in conversation)

- Plain English: simple words, short sentences.
- One idea per sentence. Active voice.
- Chunked text. Use bullets and subheadings for data.
- Layout follows ISO/IEC Directives, Part 2.
